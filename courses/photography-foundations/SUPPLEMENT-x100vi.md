...
| Control | Location | Range |
|---|---|---|
| **Aperture** | ring around the lens | f/2 – f/16, + **A** |
| **Shutter speed** | top dial | 1/4000 – 1s, **T**, **B**, + **A** |
| **ISO** | lift-and-turn collar under the shutter dial | Auto, 125 – 12800 (+ extended) |
| **Exposure compensation** | top-right dial | ±3 stops (+ **C** for ±5 via command dial) |

**Mode = which dials are on A:**

| Aperture ring | Shutter dial | → Mode |
|---|---|---|
| number | A | **Shutter-priority (S)** |
| A | number | **Aperture-priority (A)** ← home base |
| number | number | **Manual (M)** |
| A | A | **Program (P)** |

**Fine-tuning between marked values:** the front and rear **command dials** nudge shutter (in 1/3 stops via the **T** position) and aperture; assign as you like in the menu.

---

## 3. Concept → control map (follow the weeks)

| Course concept | Where it lives on the X100VI |
|---|---|
| **Aperture / depth of field** (Day 2) | Lens **aperture ring**. f/2 for blur/low light; f/4 for sharp + separation; f/8 for everything-sharp street. |
| **Shutter / motion** (Day 3) | Top **shutter dial** (full stops); command dial for 1/3 stops. **ND filter** for daytime slow shutter. |
| **ISO / noise** (Day 4) | **ISO collar** (lift outer shutter dial ring and turn), or assign ISO to a command dial, or use **Auto-ISO**. |
| **Metering / histogram / exp-comp** (Day 5) | **Exp-comp dial**; turn on **live histogram** + **"Preview Exp./WB in Manual"** in the EVF. Metering mode in the IQ/AF menu. |
| **Focus** (Day 6) | Side **focus-mode switch** (S/C/M); **focus stick (joystick)** to move the point; **Face/Eye Detection** in AF/MF menu; **focus peaking** for manual focus. |
| **White balance / color** (Day 9) | **IQ menu → White Balance**; **Film Simulation** menu for the looks. |
| **Composition aids** (Days 10–11) | **Framing Guideline** (thirds grid): Screen Set-Up menu. **Electronic level** too. Use the **EVF/OVF**. |
| **RAW vs JPEG** (Day 15) | **IQ menu → Image Quality → RAW+JPEG (Fine)**. RAW files are `.RAF`. |

---

## 4. Recommended starter setups
...
### "Landscape" setup
- **Mode:** Aperture-priority, **f/8–f/11**; **base ISO 125**; min-shutter doesn't matter on a tripod.
- **Focus:** M, focus ~1/3 into the scene using the DoF scale (or AF-S single point one-third in).
- **Stabilize:** tripod for slow/blue-hour shutters; use the **2-sec timer** or electronic shutter to avoid shake.
- **Film sim:** Velvia (punchy) for JPEG, or RAW.

### "Daytime long exposure" (silky water/clouds at noon)
- **ND filter ON** (−4 stops), tripod, **Shutter-priority** or Manual, slow shutter (e.g., 1/4–1s), low ISO, small-ish aperture. Use **B/T** for multi-second exposures.
...
| **Classic Neg / Nostalgic Neg** | filmic color shifts | street, nostalgic looks |
| **PRO Neg Std / Hi** | flat-to-punchy portrait color | studio/people |
| **Acros** | superb, tonal black & white (with grain options) | B&W everything |
