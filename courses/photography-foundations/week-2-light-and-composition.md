...
- **Side light** (from the left/right): reveals **texture and form** through shadow. It's the most sculptural, dramatic light there is, and the workhorse of good portraits and landscapes.
...
- **Top light** (overhead, e.g. noon sun): unflattering on faces, with raccoon-eye shadows under brows and nose. Avoid for portraits; can work for graphic overhead scenes.
...
The trick: **a small source can be made soft by enlarging it.** Clouds turn the tiny sun into a sky-sized softbox; a curtain turns a window into a wall of soft light. The *closer* a source is, the *bigger* (softer) it is relative to the subject. That one principle explains most of lighting.
...
Light isn't only bright or dim. It has **color**, and our brains hide that from us. A white shirt looks white under warm tungsten bulbs *and* under blue shade, because the brain auto-corrects. The camera doesn't (unless told to), so you have to understand the color of light yourself.
...
- **Auto (AWB):** the camera guesses. Good most of the time; struggles in mixed light and dim warm light (it tends to over-neutralize a sunset's lovely warmth, and sometimes you *don't* want it "corrected").
...
Composition is **the arrangement of elements within the frame**: deciding what to include, what to exclude, and where to put things. The camera is a *subtraction* tool. Out of the infinite chaos of the world, you cut one rectangle, and good composition is mostly good subtraction.

**Rule 1: Have one clear subject.** The most common beginner failure is a photo *of nothing in particular*, where the eye lands and finds no anchor. Before every frame, answer: *"What is this a photo of?"* If you can't answer in a few words, the photo will fail. Everything else serves the subject.
...
**Window light (indoors).** A window with no direct sun gives you a soft, directional light for free; it's the light the old portrait painters worked by. Place the subject *beside* it; the further from the window, the more dramatic the shadow falloff. A white wall or card opposite the window acts as a **reflector**, filling the shadows.
...
### 1. Review the week
Answer every Day 8–13 self-check from memory. The skills the rest of the course leans on: **reading light's direction & hardness** (Day 8), **the rule of thirds + clean backgrounds** (Day 10), and **the golden-hour/midday playbook** (Day 13). Reread any lecture paragraph you fumble.
