...
| Pts | Criterion |
|---|---|
| 3 | Aperture series correct; background blur visibly changes; brightness held constant |
| 2 | Shutter series shows deliberate freeze and blur |
| 2 | Reciprocity proof: all four genuinely equal in brightness; trades correctly named |
| 2 | ISO series + honest noise threshold |
| 1 | Reflection shows the settings served a real photographic need |
...
| Pts | Criterion |
|---|---|
| 4 | Three-light study: the *same* subject genuinely reads three ways; light correctly described |
| 3 | Golden-hour frame clearly exploits the light |
| 2 | Hard-light rescue: the fix demonstrably improves the shot |
| 4 | Composition set: five *distinct* tools, each working as labeled |
| 2 | Reflection shows real seeing, not just labeling |
...
| Pts | Criterion |
|---|---|
| 4 | Finished edit is clearly better *and* not overcooked |
| 4 | 7-step recipe is complete, correctly ordered, and reasoned |
| 3 | Tonal recovery genuinely restores highlight + shadow detail |
| 2 | Local adjustment demonstrably directs the eye |
| 2 | Restraint check shows editing judgment |
...
| Pts | Criterion |
|---|---|
| 5 | Coherence: the ten frames read as one body of work with a clear point of view |
| 5 | Technical floor met across all ten (exposure, focus, sharpness) |
| 5 | Light and composition are strong and *varied* in service of the theme |
| 4 | Editing is consistent and tasteful (a "look"), not overcooked |
| 4 | Artist's statement defends the choices correctly and shows intent |
| 2 | Sequencing/presentation: ordered deliberately, opens and closes strong |

**Master's bar:** 23+/25, *and* a stranger could look at the ten frames and describe your point of view without reading the statement.
