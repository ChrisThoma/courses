...
### Shoot
1. **(20 min) The aperture ladder.** Put the camera in **Aperture-priority** (the mode where you pick the aperture and the camera handles the shutter; see Day 5). Pick a subject ~2 m away with a background well behind it. Shoot the *same frame* at f/2 (or your widest), f/4, f/5.6, f/8, f/16. Keep everything else identical.
...
**ISO also counts in stops**, with each doubling worth one stop more light: 100 → 200 → 400 → 800 → 1600 → 3200…
...
- **A scene full of white** (snow, a white wall, a bride's dress): the meter tries to make it *gray*, so it **underexposes**, and your snow comes out dingy gray. Fix: add **+1 to +2 stops** of exposure.
...
### Look
- Pull up any snow or beach photo and any night photo. Look at the histograms (most cameras and editors show them). See how different they are, and how both are "correct." Find a backlit silhouette and understand it as a metering decision (the camera, or photographer, exposed for the bright background).
...
**Two autofocus (AF) modes**, matched to whether the subject moves:
