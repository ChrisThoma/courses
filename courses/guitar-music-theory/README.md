...
This course covers **everything a guitarist needs from music theory and nothing more**:

- The fretboard as a map of notes and intervals
...
2. Each day, work the lesson in order: **Lecture → Examples (play them) → Exercises → Self-check.**
3. **Always with a guitar in your hands.** Theory you can't play is trivia. Every concept in this course is learned *on the fretboard*, not on paper.
4. Take quizzes closed-book. Grade yourself honestly against `ANSWER-KEYS.md` and the rubric.
5. Do the projects. They are where the learning actually consolidates.
