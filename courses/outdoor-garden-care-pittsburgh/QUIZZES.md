...
4. A plant tag reads "Zones 7–10." What does that mean for growing it outdoors here?
5. Define full sun, part sun, and full shade in hours of direct sun.
6. How does a south/west-facing slope differ from a north/east-facing one?
7. Give one example of a warm microclimate and one of a cold microclimate.
8. Why don't you plant tomatoes in Pittsburgh in late April?
...
4. What is the difference between soil *texture* and soil *structure*, and which can you change?
5. What single amendment improves clay structure, and how?
6. Explain "feed the soil, not the plant" in one sentence.
7. What does soil pH control, and what range do most plants want?
8. Which way do Pittsburgh soils usually skew on pH, and what do you add to fix it?
9. In a fertilizer labeled 10-5-5, what does each number represent (by symbol)?
10. Which nutrient drives leafy green growth? Which drives flowers/fruit/roots?
...
4. Why water in the morning and at the base rather than overhead in the evening?
5. How do you decide whether to water today (the simplest reliable test)?
6. List four things a 2–3 inch mulch layer does for you.
7. Why should mulch be kept off stems and trunks?
8. Name two clay-drainage "fixes" that are actually myths or make it worse.
...
4. Why might a plant wilt at 3 p.m. on a hot day and recover by morning?
5. Define annual, perennial, and biennial.
6. Give a Pittsburgh example of each of the three.
7. State the master principle "right plant, right place" and why it matters.
8. A tomato in 3 hours of sun grows tall, pale, and fruitless. Diagnose it.
...
4. Name two invasive ornamentals to avoid in Pittsburgh.
5. When do you plant tender crops here, and when is the *best* time to plant a tree?
6. Describe the correct planting hole (shape and depth) and why deep-and-narrow fails in clay.
7. What is "planting too deep," and why does it kill?
8. What is hardening off, and why is it necessary?
...
4. Which is the bigger killer in Pittsburgh clay, and why?
...
4. When do you prune a panicle hydrangea (blooms on new wood)?
5. Describe a correct pruning cut.
6. Name two things you must never do (stub, flush cut, or topping).
7. Why disinfect pruners between plants?
8. What does deadheading accomplish?
...
4. Name the IPM "threshold" idea in one sentence.
5. What's the first step before treating any suspected pest?
6. Name three cultural practices that prevent most fungal disease in our humid climate.
7. A pepper wilts and yellows in soggy soil with brown roots. Pest or culture problem? What's the fix?
8. What is the spotted lanternfly, and what should you do about egg masses?
9. Why should you never spray insecticide on open flowers?
10. What does "the label is the law" mean for pesticide use?
...
7. Four jobs a mulch layer does?
8. Why is light non-negotiable for a plant?
...
4. Before fertilizing, you should ____.
5. The spring- vs. summer-bloomer pruning rule?
6. When do you prune a lilac, and why?
7. Three reasons to choose native plants?
8. Two invasive ornamentals to avoid?
...
4. "One year's seeding, ____ years' weeding."
...
4. When is crabgrass pre-emergent applied, and what's the folk indicator?
5. Two good reasons to right-size a lawn?
6. Why is biodiversity "the cheapest insurance in the garden"?
7. Four ways to design for pollinators and the food web?
8. What are the vertical layers of a planting, and how does the ground layer suppress weeds?
9. Why is fall the most underrated season? Name two fall tasks.
10. Two things you should deliberately NOT do in late summer/fall?
